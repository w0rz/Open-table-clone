...
<input type="text" className="border rounded p-3 w-80 mb-4" placeholder="E-mail"/>
...
<button className="bg-red-600 w-full p-3 text-white font-bold rounded disabled:bg-gray-300">Complete resevation</button>
</div>
  )
}
